...
export const summary = {
  ...
  paragraphs: [
    "I specialise in the operational core of a business: the coordination, documentation and communication work that keeps everything else moving. Over 15 years across financial services, automotive fleet management, remittance banking and office administration in Saudi Arabia, I have built a track record of being the person teams rely on when accuracy and follow-through are non-negotiable.",
    "My experience spans both customer-facing and back-office work. On the customer side, I have handled high volumes of complex enquiries, including disputed transactions, delayed transfers and escalated complaints, and resolved them in ways that retain trust rather than just close tickets. On the operational side, I have managed fleet scheduling, driver dispatch, vendor coordination, contracts and insurance records, compliance documentation, executive calendars and correspondence, and branch reporting across demanding, fast-moving environments.",
    "More recently I have invested in formal upskilling, including Supply Chain Management (Rutgers University), Inventory Management, SAP ERP, Oracle Aconex, Administrative Assistance and Google AI Essentials, to pair hands-on experience with modern tools and systems. I am multilingual in English, Arabic, Bengali and Hindi/Urdu, and comfortable working across diverse teams and client bases.",
  ],
};
